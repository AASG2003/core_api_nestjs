...
export class NuevaMigracion1749420656081 implements MigrationInterface {
    name = 'NuevaMigracion1749420656081'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`lote\` (\`LoteID\` int NOT NULL AUTO_INCREMENT, \`FechaProduccion\` date NULL, \`FechaVencimiento\` date NULL, \`CantidadProducida\` int NULL, \`costo_produccion\` decimal(10,0) NULL, \`Proveedor_ProveedorID\` int NOT NULL, INDEX \`fk_Lote_Proveedor1_idx\` (\`Proveedor_ProveedorID\`), PRIMARY KEY (\`LoteID\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`productos\` (\`ProductoID\` int NOT NULL AUTO_INCREMENT, \`Nombre_producto\` varchar(50) NULL, \`Precio_unidad\` decimal(10,0) NULL, \`FechaLanzamiento\` date NULL, \`Categoria_Producto_CategoriaID\` int NOT NULL, INDEX \`fk_Productos_Categoria_Producto1_idx\` (\`Categoria_Producto_CategoriaID\`), PRIMARY KEY (\`ProductoID\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`usuarios\` (\`usuarioID\` int NOT NULL AUTO_INCREMENT, \`NombreCompleto\` varchar(45) NULL, \`CI\` int NULL, \`email\` varchar(45) NULL, \`Fecha_nacimiento\` date NULL, \`Genero\` tinyint NULL, \`Roles_RolID\` int NOT NULL, INDEX \`fk_Usuarios_Roles1_idx\` (\`Roles_RolID\`), PRIMARY KEY (\`usuarioID\`)) ENGINE=InnoDB`);
